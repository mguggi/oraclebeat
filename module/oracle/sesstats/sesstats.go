...
const selector = "oracle/sesstats"

// init registers the MetricSet with the central registry.
// The New method will be called after the setup of the module and before starting to fetch data
func init() {
	if err := mb.Registry.AddMetricSet("oracle", "sesstats", New, oracle.ParseDSN); err != nil {
		panic(err)
	}
}
...
func New(base mb.BaseMetricSet) (mb.MetricSet, error) {
	...
	logp.Info("EXPERIMENTAL: The oracle sesstats metricset is experimental")
	...
	stmt, err := db.Prepare(
		"select /* metricset: sesstats */ * from gv$sess_time_model")
